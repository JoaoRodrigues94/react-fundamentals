...
//const smallBox = <div className="box box--smal" style={{backgroundColor: 'lightblue', fontStyle: 'italic'}}>small lightblue box</div>
  ...
  return (
    <div>
        {/*
            ...
            O valor das propriedades entre aspas, caso não seja numérico.
        */}
      <div style={ {marginTop: '20px', backgroundColor: 'blue'} }>Teste</div>  
      <Box size="small" id="box1" >Small light blue Box</Box>
